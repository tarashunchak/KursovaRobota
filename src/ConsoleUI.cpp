...
///////////////////////////////////
Person person[3]{Person("Taras", "Hunchak", "20.04.2007", MALE),
                 Person("Joe", "Biden", "10.03.2001", MALE),
                 Person("Ilona", "Musk", "11.09.2001", FEMALE)};

Person cust[3]{Person("Olga", "Ivanova", "15.06.1995", FEMALE),
               Person("John", "Smith", "22.08.1988", MALE),
               Person("Emily", "Davis", "05.02.1992", FEMALE)};

Customer customers[3]{Customer(cust[0], SIM("+380991234567", Balance(100))),
                      Customer(cust[1], SIM("+380996543210", Balance(240))),
                      Customer(cust[2], SIM("+380993456789", Balance(400)))};

Tariff tariff[3]{Tariff("JoicePro", 1500, 265), Tariff("SuperNet", 2500, 463),
                 Tariff("Standart", 2000, 300)};

SIM sim[4]{
    SIM("+380992210001", Balance(200)), SIM("+380654321023", Balance(250)),
    SIM("+380604556645", Balance(120)), SIM("+380933344553", Balance(493))};
      ...
      if (role == meCust.role /*Customer*/) {
        ...
        /*0*/ reload_myprofile:
          ...
          if (inputint == 0)
            ...
            if (choice > tariffManager.getSize() || choice == 0)
              break;

            requestManager.sendRequest(customerManager.getCustomer(UserID),
                                       tariffManager.getTariff(choice));
          }
        ...
        case 2: {
          ...
          cout << " __________________________________________________\n"
               ...
               << endl;
          cout << "|Balance:"
               << customerManager.getMobile(UserID).getBalanceValue() << "$";
          checkStringLength(
              to_string(customerManager.getMobile(UserID).getBalanceValue())
                  .length() +
              3);
          cin >> inputint;
          break;
        ...
        /*1*/ reload_phonebook:
          ...
          case 1: {
            ...
            moveLeft(47);
            cin >> pnumb;
            customerManager.getMobile(UserID).addContact(
                SIM("+380" + pnumb, Balance(0)));
          ...
          case 3: {
            ...
            moveLeft(34);
            cin >> contact_id;
            customerManager.getMobile(UserID).getMyPhone()->makeCall(
                contact_id);
          }
          default: {
            break;
        ...
        case 4: {
          cout << " __________________________________________________\n"
               ...
               << "|--------------------------------------------------|"
               << endl;
          if (!customerManager.getMobile(UserID)
                   .getMyPhone()
                   ->getCallHistoryStatus()) {
            printEmptyMenu();
          } else {
        ...
        case 5: {
          string massages = "";
          chatManager.startChat(customerManager.getCustomer(UserID).getPerson(),
                                managerController.getManager(1).getPerson());
          cout << " __________________________________________________\n"
               << "|" << setw(15) << "" << "Chats" << setw(15) << " | \n"
               << "|--------------------------------------------------|"
               << endl;
          chatManager.printChats();
          /*cout << "|" << chatManager.getSize() + 1 << ")Start chat" <<
             setw(20) << "|\n"
          ...
          /*2*/ reload_massage:
            ...
            if (inputint == 0)
              ...
              // chatManager.sendMassage(Massage(meCust.getPerson().getF_Name(),
              // massages, managerController));
        ...
        /*2*/ reload_customer:
          ...
          if (inputint == 0)
            ...
            bool gender;
            cout << " __________________________________________________\n"
                 << "|" << setw(18) << "" << "Add Subscriber" << setw(19) << "|"
                 << endl;
            cout << "|--------------------------------------------------|"
                 << endl;
            cin.ignore();
...
void checkStringLength(size_t l) { cout << "" << setw(52 - l) << "|" << endl; }
